...
won't fit `030-requirements.kb/session-fits-a-45-60-minute-timebox.md`, split
it into `NN`/`NNb` rather than compressing — see
`../../discourse.kb/questions.kb/` for sessions still under review for a split.
Mark `status: done` after a session actually runs with Abby.
